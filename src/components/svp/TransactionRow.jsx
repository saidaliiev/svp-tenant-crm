  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-2 sm:mb-3">
        <span className="text-xs sm:text-sm font-medium text-slate-500">#{index + 1}</span>
        <div className="flex items-center gap-2">
          ...
          {canDelete && (
            <Button variant="ghost" size="sm" onClick={onDelete} className="text-red-500 hover:text-red-700 hover:bg-red-50 h-7 w-7 p-0">
      ...
      <div className="hidden sm:grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="space-y-1 lg:col-span-2">
          <Label className="text-xs text-slate-500">RAS (€)</Label>
          <div className="flex items-center gap-2">
      ...
      <div className="sm:hidden space-y-2">
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="space-y-1">
            <Label className="text-[10px] text-slate-400">RAS (€)</Label>
        ...
        <div className="flex gap-3">
          <div className="flex items-center gap-1.5">
            ...
            <Label htmlFor={`m-tenant-paid-${transaction.id}`} className="text-[11px] cursor-pointer text-slate-600">Tenant Paid</Label>
          </div>
          <div className="flex items-center gap-1.5">
            ...
            <Label htmlFor={`m-ras-received-${transaction.id}`} className="text-[11px] cursor-pointer text-slate-600">RAS Received</Label>
          </div>
        </div>
      </div>
    </div>
